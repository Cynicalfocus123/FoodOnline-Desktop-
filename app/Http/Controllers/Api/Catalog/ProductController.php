...
class ProductController extends Controller
{
    ...
    {
        $item=$this->visibleQuery(['public','catalog_only'])->where('slug',$product)->with(['category','brand','defaultVariant','primaryMedia','activeVariants','media'=>fn($q)=>$q->ordered()])->firstOrFail();
