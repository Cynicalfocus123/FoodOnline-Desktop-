...
- The top hero image box uses the supplied table-sharing food image at `public/images/about/about-food-table.png`, rendered as a rounded full-cover image inside the existing wide hero box.
