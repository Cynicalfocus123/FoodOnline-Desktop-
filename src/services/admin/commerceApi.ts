...
export type Promotion = { uuid: string; code: string; name: string; description: string | null; discount_type: "percentage" | "fixed"; discount_value: number; minimum_subtotal_minor: number | null; maximum_discount_minor: number | null; currency_code: string | null; starts_at: string | null; ends_at: string | null; total_usage_limit: number | null; per_user_usage_limit: number | null; usage_count: number; active: boolean; applies_to: string; status: string; updated_at: string };
