...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <article
      className="flex h-full w-[188px] shrink-0 snap-start cursor-pointer flex-col rounded-[24px] border border-neutral-200 bg-white p-3 shadow-[0_10px_24px_rgba(15,23,42,0.04)] transition hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(15,23,42,0.08)] sm:w-[198px]"
      onClick={handleOpen}
