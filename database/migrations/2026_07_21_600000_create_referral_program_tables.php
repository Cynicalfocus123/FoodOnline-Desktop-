...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('referral_programs')->insert([
            ...
            'referee_benefit_copy' => 'New Customer, Supplier, and Partner accounts receive account-bound referral coupons after registering through an eligible invitation.',
            'invite_page_heading' => 'You have been invited to FoodOnlines',
            'invite_page_copy' => 'Create a Customer, Supplier, or Partner account and receive an account-bound referral discount on qualifying orders.',
            'share_message' => 'Join FoodOnlines using my referral link and receive an account-bound discount on qualifying orders. I may also receive a FoodOnlines referral reward.',
            'terms_content' => 'New public accounts must be Customer, Supplier, or Partner accounts and may have only one referrer. Referral coupons are account-bound and non-transferable. Rewards are issued only after qualifying orders are delivered and payment is collected. Minimum orders, deadlines, expiration, review, and revocation rules are controlled by the active program.',
            'starts_at' => $now,
            'created_at' => $now,
            'updated_at' => $now,
        ]);
