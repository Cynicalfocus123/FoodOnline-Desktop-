...
- The synchronized backend mirror contains 291 files / 975,384 bytes (290 source files plus `SHA256SUMS`). Temporary clean stages are deleted after verification, leaving exactly two visible release items. Final mandatory clean ZIPs are: frontend 1,036 files / 90,946,526 bytes / SHA-256 `264bd5a45dda1b2d8df9e665921acc22e7f843f6229b59f510ff8825eaab92dd`; backend 291 files / 291,377 bytes / SHA-256 `154c75369948ab87d4e2997e430c1a8a43dd6da04dd6f3d872ca212d6127d123`. Both passed the full paired release gate; external Hostinger deployment remains unconfirmed.
...
- `backend-live/` is the complete controlled Laravel mirror: 288 source files plus `SHA256SUMS`, 289 files / 966,169 bytes. The backend release archive is 289 files / 297,499 bytes / SHA-256 `26e54fdf3c869124ad887c03973214a247a1bab1cd60fbccd8adceb7de09fc81`.
