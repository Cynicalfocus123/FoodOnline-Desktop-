...
| Production audit | 28 routes; 1,016 files / 89,887,601 bytes; zero missing local references or placeholder links |
...
| `dist/` | 1,016 files / 89,887,601 bytes |
| `frontend-upload/` | 1,016 files / 89,887,601 bytes; exact SHA-256 parity with `dist/` |
