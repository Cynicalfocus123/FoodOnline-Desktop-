...
2026-07-18 review: category authority and optional product-media changes preserve cart, quote, inventory, promotion, order, COD, and exact-variant contracts. Full Laravel regression tests cover these paths.
