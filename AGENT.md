...
- Admin Categories loads every page with lifecycle views, keeps selection after save, supports optional Images and SEO/Redirects, neutral media states, bottom Save, archive/restore, and archived-only exact-slug permanent deletion with product/child safeguards.
