...
- The clean release command now replaces both external staging folders from current `dist/` and `backend-live/` automatically before packaging. Final mandatory archives passed all standard Deflate ZIP32, CRC, Windows/PHP extraction parity, manifest, path/metadata, and forbidden-content gates: frontend 1,036 files / 90,946,526 bytes / SHA-256 `1d7254e9df025d4bad330b642f737755f3ddcf00ad12c35314a22314ee4aae90`; backend 291 files / 291,280 bytes / SHA-256 `ff23a5548a7fab071814b5ea0627614463139d393769b8ee7bc4aa7b636a71cf`.
