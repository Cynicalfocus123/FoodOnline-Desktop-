...
{
    public function index(Request $request): JsonResponse { return response()->json(['data' => SupportTicket::query()->with(['user', 'order', 'media'])->latest('last_message_at')->paginate(25)]); }
