...
Route::prefix('v1')->group(function (): void {
    ...
    Route::prefix('admin')->group(function (): void {
        ...
        Route::middleware(['admin.token', 'throttle:api', 'admin.permission'])->group(function (): void {
            ...
            Route::get('/referrals', [AdminReferralController::class, 'index'])->middleware('admin.permission:referrals.view')->name('api.v1.admin.referrals.index');
            Route::get('/referral-settings', [AdminReferralController::class, 'settings'])->middleware('admin.permission:referrals.view')->name('api.v1.admin.referrals.settings.show');
            Route::put('/referral-settings', [AdminReferralController::class, 'updateSettings'])->middleware('admin.permission:referrals.manage')->name('api.v1.admin.referrals.settings.update');
            Route::get('/referrals/{referral}', [AdminReferralController::class, 'show'])->middleware('admin.permission:referrals.view')->name('api.v1.admin.referrals.show');
            Route::get('/referrals/{referral}/qualification', [AdminReferralController::class, 'qualification'])->middleware('admin.permission:referrals.view')->name('api.v1.admin.referrals.qualification');
            Route::get('/referrals/{referral}/rewards', [AdminReferralController::class, 'rewards'])->middleware('admin.permission:referrals.view')->name('api.v1.admin.referrals.rewards');
            Route::get('/referrals/{referral}/audit-history', [AdminReferralController::class, 'auditHistory'])->middleware('admin.permission:referrals.view')->name('api.v1.admin.referrals.audit-history');
            Route::get('/referrals/{referral}/notifications', [AdminReferralController::class, 'notifications'])->middleware('admin.permission:referrals.view')->name('api.v1.admin.referrals.notifications');
            Route::post('/referrals/{referral}/actions', [AdminReferralController::class, 'action'])->middleware('admin.permission:referrals.manage')->name('api.v1.admin.referrals.action');
