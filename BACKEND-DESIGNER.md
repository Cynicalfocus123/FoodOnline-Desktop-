...
- Admin phase 1 mockup includes standalone login screen, dark sidebar dashboard, `Users` role tabs for `Customers`, `Suppliers`, and `Partners`, and admin settings panel for credential rotation.
